...
extern int generate_indirect_matmul_code(pim_args *pim_args);
extern int matmul_indirect(pim_args *pim_args);

extern int generate_indirect_lut_code(pim_args *pim_args);
extern int lut_op(pim_args *pim_args);

extern int lut_search_all(pim_args *pim_args);
