...
void matmul_pim(short *A, short *B, short *C, pim_args *pim_code, size_t M, size_t N, size_t K) {
...
int main(int argc, char **argv) {
  ...
  // all data movement cost can be removed.
    ...
    switch (device) {
      ...
      case 1: matmul_pim(srcA_pim, srcB_pim, dstC_pim, pim_code, p_size, r_size, q_size); break;
