...
class Tensor final {
  ...
  */
  ...
  // For PIM alignment
  inline void SetOriginalShape(const TensorShape& org_shape) {
    recovery_shape_ = org_shape;
  }
  const TensorShape& GetOriginalShape() const noexcept { return recovery_shape_; }

  inline void SetIsPim() { 
    is_pim_ = true;
  }
  bool GetIsPim() const { return is_pim_; }

  inline void SetLayoutChanged(bool value = true) {
    data_layout_changed_ = value;
  }
  bool GetLayoutChanged() const  { return data_layout_changed_; }

  inline void SetIsMatrixB(bool value = true) {
    is_b_ = value;
  }
  bool GetIsMatrixB() const  { return is_b_; }

  inline void SetIsMatrixBDecooupled(bool value = true) {
    is_decoupled_weight_ = value;
  }
  bool GetIsMatrixBDecooupled() const  { return is_decoupled_weight_; }

  inline void SetIsTransB(bool value = true) {
    is_trans_B_ = value;
  }
  bool GetIsTransB() const  { return is_trans_B_; }
  ...
  */
  ...
  TensorShape recovery_shape_;
  bool is_pim_ = false;
  bool data_layout_changed_ = false;
  bool is_b_ = false;
  bool is_decoupled_weight_ = false;
